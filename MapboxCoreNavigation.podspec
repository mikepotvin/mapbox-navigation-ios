Pod::Spec.new do |s|
  ...
  s.source = { :git => "https://github.com/mikepotvin/mapbox-navigation-ios.git", :tag => "v#{s.version.to_s}" }
  ...
  s.resource_bundles = {'MapboxCoreNavigationResources' => ['Sources/MapboxCoreNavigation/Resources/*/*', 'Sources/MapboxCoreNavigation/Resources/*']}
